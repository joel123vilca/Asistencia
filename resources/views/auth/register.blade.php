            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                             <label for="rol" class="col-md-4 control-label">Seleccionar Rol</label>
                         <select class="col-md-4 control-label" id="rol" name="rol">
                             <option value="docente" class="col-md-4 control-label">Docente</option>
                            <option value="alumno" class="col-md-4 control-label">Alumno</option>
                        </select>
                        </div>
                        <div class="form-group">
